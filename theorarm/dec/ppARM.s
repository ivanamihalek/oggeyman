...
@ Copyright (C) 2009 Robin Watts for Pinknoise Productions Ltd
	...
	.global	oc_filter_hedge
	.global	oc_filter_vedge
	.global	oc_dering_block
...
ofhs_lp:
	...
	MOV	r9, #0
	USADA8	r14,r9,r4,r14		@ r14=variance0sum+=sum of sum0s
	USAD8	r9, r9,r6		@ r9 =sum of sum1s
	ADD	r14,r14,r9, LSL #12	@ r14=variance1sum+=sum of sum1s
...
oc_dering_block:
	...
	TST	r2, #4
	SUBNE	r8, r8, r1		@ r8 = psrc = src-(ystride&-!!(b0x4))
	MOV	r9, r13			@ r9 = vmod
	MOV	r14,#8			@ r14= by=8
odb_lp1:
	MOV	r12,#8			@ r12= bx=8
...
odb_sharp1:
	...
	TST	r2, #8			@ if (b0x8)        (reversed earlier!)
	TSTEQ	r14,#0xFE		@          || (by>1)
	...
	MOV	r8, r0			@ r8 = psrc = src
	TST	r2, #1
	SUBNE	r8, r8, #1		@ r8 = psrc = src-(b0x1)
...
odb_sharp2:
	...
	MOV	r7, r8			@ r7 = src= psrc
	TST	r2, #2			@ if (b0x2)        (reversed earlier!)
	TSTEQ	r14,#0xFE		@          || (bx>1)
	ADDNE	r7, r7, #1		@ r7 = src= psrc+((b0x2)|(bx>1))
	SUBS	r14,r14,#1
	BGE	odb_lp3
	...
	TST	r2, #4
	SUBNE	r4, r4, r1		@ r4 = psrc=src-(ystride&-!(b0x4))
...
odb_lp5:
	...
	AND	r9, r2, #1		@ r9 = (b0x1)
	LDRB	r9, [r0, -r9]		@ r9 = *(src-(b0x1))
	MOV	r11,#64			@ r11= d = 64
	LDRSB	r7, [r5], #1		@ r7 = w1=*pvmod++
	MLA	r11,r9, r10,r11		@ r12= d+=w0* *(src-(b0x1))
...
odb_lp6:
	...
	SUB	r12,r12,r7		@ r12= a -= w1
	LDRB	r7, [r0]		@ r7 = src[0]
	MLA	r11,r9, r10,r11		@ r11= d+= w3 * src[(b0x2)>>1]
	SUB	r12,r12,r10		@ r12= a -= w3
