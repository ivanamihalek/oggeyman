...
void oc_frag_copy(unsigned char *_dst,
...
void oc_frag_copy_list(unsigned char *dst_frame_data,
...
#define oc_state_frag_copy_list(S,F,N,D,C,P)                      \
  oc_frag_copy_list((S)->ref_frame_data[(S)->ref_frame_idx[(D)]], \
                    (S)->ref_frame_data[(S)->ref_frame_idx[(C)]], \
                    (S)->ref_ystride[(P)],                        \
                    (N),                                          \
                    (F),                                          \
                    (S)->frag_buf_offs)
